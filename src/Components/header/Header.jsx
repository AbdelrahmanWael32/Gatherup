...
return ( <div className="bg-[#04092C]">
{/* Top Navigation Bar */} <nav className="sticky w-full top-0 z-50 bg-[#04092C] border-b border-[#04092C] shadow-lg"> <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> <div className="flex items-center justify-between h-16">
{/* Logo */} <div className="flex-shrink-0"> <Link to="/" className="text-2xl font-bold text-white"> <span className="text-blue-500">G</span>ATHERUP </Link> </div>
...
```
        ...
        {/* Auth Buttons & Cart - always visible */}
