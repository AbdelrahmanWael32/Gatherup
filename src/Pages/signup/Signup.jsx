...
function SignUpPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-100 to-blue-gray-50">
      <Card className="w-full max-w-3xl p-1 shadow-xl border border-purple-200 bg-white">
        <CardBody>
          <Typography
            variant="h4"
            color="purple"
          ...
          <form onSubmit={handleNewUser} className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3">
              <Checkbox id="agree" color="purple" />
            ...
            {errors.length > 0 && (
              <div className="mt-3">
                {errors.map((err, index) => (
                  <Typography
                    key={index}
                    color={err.includes("succ") ? "green" : "red"}
